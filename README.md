...
<h1>Запланировано:</h1>
<ul><li>Доработка личного кабинета:<ul><li>Создание валюты за которую можно будет покупать внутриигровые  вещи.</li><li>Возможность пополнения валюты при помощи киви.</li><li>Возможность изменять скин персонажа в личном кабинете.</li><li>Добавление инвайтов за проведенное в игре время.</li></ul></li><li>Создание админки с основными графиками и всевозможными функциями  работы с пользователями, полезными администратору.</li></ul>